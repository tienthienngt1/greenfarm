    ...
    <div id="app" class="container mt-4" style="max-width:1000px;min-width:700px">
        <div class="container justify-content-center">
            ...
            <div class="float-right mt-5">
                @guest
                <a class="btn btn-outline-dark " href="{{ route('login') }}"><i class="fas fa-user mr-2"></i>Đăng nhập</a>
                <a class="btn btn-outline-dark " href="{{ route('register') }}"><i class="fas fa-user-plus mr-2"></i>Đăng kí</a>
                @else
                <a href="{{ route('logout') }}" class="btn btn-outline-dark" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt mr-2"></i>Đăng xuất</a>
        ...
        <div class="shadow mb-4 mt-4 p-2 general">
            <marquee scrolldelay="200" onmouseover="this.stop()" onmouseout="this.start()">
                <span class="mr-4">Chúc mừng bạn đã nhận nuôi thành công <span style="color:red">gà vườn</span></span><span class="mr-4">Chúc mừng bạn đã nhận nuôi thành công <span style="color:red">gà vườn</span></span>
            </marquee>
        </div>
        <div class="mb-4 shadow d-flex align-items-center general" style="height: 60px;">
            ...
            <span class="" style="width: 20%;">
                <center>
                    <a href="/cua-hang" class="btn btn-outline-dark @if(strpos(url()->current(),'cua-hang')) active @endif">
            ...
            <span class="" style="width: 20%;">
                <center>
                    <a href="/tien-trinh" class="btn btn-outline-dark @if(strpos(url()->current(),'tien-trinh')) active @endif">
            ...
            <span class="" style="width: 20%;">
                <center>
                    <a href="/ca-nhan" class="btn btn-outline-dark @if(strpos(url()->current(),'ca-nhan')) active @endif">
            ...
            <span class="" style="width: 20%;">
                <center>
                    <a href="/huong-dan" class="btn btn-outline-dark @if(strpos(url()->current(),'huong-dan')) active @endif">
